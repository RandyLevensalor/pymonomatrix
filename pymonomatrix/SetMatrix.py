...
class SetMatrix:
    ...
    def set_volume(self, output, volume):
        ...
        try:
            output_index = self._output_audio_labels_map[output] + 1
        except KeyError:
    ...
    def set_video_output(self, output: str, input_val: str):
        ...
        try:
            video_index = self._output_video_labels_map[output] + 1
        except KeyError:
            print(f"Output {output} not found in output_video_labels")
            return False
        try:
            input_index = self._input_labels_map[input] + 1
        except KeyError:
    ...
    def set_audio_output(self, output: int, input_val: int):
        ...
        try:
            audio_index = self._output_audio_labels_map[output] + 1
        except KeyError:
            print(f"Output {output} not found in output_audio_labels")
            return False
